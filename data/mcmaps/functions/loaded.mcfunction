scoreboard objectives add hn.adrenaline dummy
scoreboard objectives add hn.adrcountdown dummy
scoreboard objectives add hn.motion_x1 dummy
scoreboard objectives add hn.motion_y1 dummy
scoreboard objectives add hn.motion_z1 dummy
...
function mcmaps:enemies/particles
